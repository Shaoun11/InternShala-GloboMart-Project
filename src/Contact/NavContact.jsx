...
import Contact from '../Components/Contacr';
...
const NavContact = () => {
    ...
    <div className="container px-6 pt-6 mx-auto">
        <div className="text-center ">
            <p className="font-semibold text-2xl lg:text-5xl md:text-4xl  text-black ">Contact <span className='text-secondary'>Us</span></p>
        </div>
...
<div className="grid grid-cols-1 max-w-7xl mb-28 mx-auto gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            <div className="p-4 rounded-lg  md:p-6 bg-white">
                <span className="inline-block p-3 text-white rounded-lg  bg-secondary">
        ...
        <div>
            <h1 className='text-6xl text-black  font-semibold text-center'>Our <span className='text-secondary'>Location</span></h1>
